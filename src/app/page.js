      ...
      <div className="top-5% mt-10 text-black md:text-lg">
        ...
        <div className="top-5% left-10 right-20 bg-slate-200 rounded-2xl mt-10 text-black md:text-lg flex flex-col justify-center items-center p-8">
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            2. <a href="https://en.wikipedia.org/wiki/Henry_Sy" target="_blank" rel="noopener noreferrer"><b>Henry Sy (Shoe Mart)</b></a> - Shoe Mart, or SM for short, is one of the country’s retail behemoths, and far more than just a mall.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            3. <a href="https://en.wikipedia.org/wiki/Tony_Tan_Caktiong" target="_blank" rel="noopener noreferrer"><b>Tony Tan Caktiong (Jollibee Foods)</b></a> - The cheerful tagline “langhap sarap” – a Jollibee trademark – is well-known among Filipinos.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            4. <a href="https://en.wikipedia.org/wiki/Socorro_Ramos" target="_blank" rel="noopener noreferrer"><b>Socorro Ramos (National Book Store)</b></a> - Socorro Ramos began her career in publishing and retail as a salesgirl in a bookshop. With a capital of PHP200, she and her husband launched National Book Store in Escolta at the age of 19, selling books and school supplies to children. The Japanese imposed censorship on books and publications at the time, which included her burgeoning business. She and her husband supplemented their income by selling other products such as candles and soaps.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            5. <a href="https://en.wikipedia.org/wiki/John_Gokongwei" target="_blank" rel="noopener noreferrer"><b>John Gokongwei Jr. (J.G. Holdings)</b></a> - Born in China, John Gokongwei Jr. was the heir to one of Cebu’s wealthiest families.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            6. <a href="https://en.wikipedia.org/wiki/Edgar_Sia" target="_blank" rel="noopener noreferrer"><b>Edgar Sia (Mang Inasal)</b></a> - Edgar Sia, the brains behind Mang Inasal, is widely regarded as the Philippines’ pioneer in limitless rice meals.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            9. <a href="https://businessasmission.ph/drceciliopedro" target="_blank" rel="noopener noreferrer"><b>Cecilio Kwok Pedro (Lamoiyan Corporation)</b></a> - The story of Cecilio Kwok Pedro is a classic example of Filipino entrepreneurial spirit overcoming the odds.
          ...
          <p className="mt-10 w-full max-w-3xl text-lg text-justify ">
            10. <a href="https://en.wikipedia.org/wiki/Alfredo_Yao" target="_blank" rel="noopener noreferrer"> <b>Alfredo M Yao (Zest-O)</b></a> - Alfredo Yao’s father died when he was 12; his mother supported him and his siblings by working as a street vendor. Yao was able to attend college at the Mapa Institute of Technology thanks to the help of a family member, but did not complete it.
